...
import { CloudUpload, FolderOpen, ImageIcon, FileText, Package, Sun, Moon } from 'lucide-react';

const Sidebar = ({ activeCategory, setActiveCategory, totalSize = 0, theme, setTheme }) => {
    ...
    return (
        <motion.div
            ...
            className="w-72 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800/80 min-h-screen p-6 flex flex-col relative z-30 shadow-[4px_0_24px_rgba(0,0,0,0.02)] dark:shadow-none transition-colors duration-300"
        >
            {/* Brand Header */}
